    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-md-4 p-3">
                ...
                {{--style="border: 5px solid rgba(255,255,255,0.9);position: absolute;width: 86%;height: 90%;top: 50%;left: 50%;transform: translate(-50%,-50%)">--}}
            ...
            <div class="col-md-8">
                ...
                <div class="row pt-4 statistics">
                    ...
                    <div class="col-md-3 mb-2 col-sm-6 col-6 text-center">
                        <img src="{{URL::asset('images/icon/house.png')}}" alt=""
                             style="width: 64px;height: auto;margin: auto">
                        <p><span style="color: red" id="counter-number2">3000+</span> NHÀ PHỐ</p>
                    </div>
